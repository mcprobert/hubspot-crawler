...
def main():
    ...
    p.add_argument("--out", help="Output file (JSONL or CSV depending on --output-format)")
    p.add_argument("--output-format", choices=["jsonl", "csv"], default="jsonl", help="Output format: jsonl (default) or csv")
